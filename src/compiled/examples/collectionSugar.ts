                        ...
                        (seq
                         (new $arr
                          (seq
                           ...
                           (call %init_peer_id% ("op" "identity") [$stream-inline] $arr-fix-0)
                          )
                         )
                         (call %init_peer_id% ("op" "identity") [$str] $str-fix-1)
                        )
                       )
                      )
                      (xor
                       (call %init_peer_id% ("callbackSrv" "response") [$arr-fix-0 $str-fix-1])
    ...
    let script = `
                    (xor
                     (seq
                      ...
                      (xor
                       (call %init_peer_id% ("callbackSrv" "response") [option-inline-0 $str-fix-1 option-inline-1-0])
                       (call %init_peer_id% ("errorHandlingSrv" "error") [%last_error% 1])
                      )
                     )
                     (call %init_peer_id% ("errorHandlingSrv" "error") [%last_error% 2])
                       ...
                       (new $strStream
                        (seq
                         (new $strArr
                          (seq
                           (new $numOp
                            (call %init_peer_id% ("op" "identity") [[]] $numOp-fix-0)
                           )
                           (call %init_peer_id% ("op" "identity") [[]] $strArr-fix-1)
                          )
                         )
                         (call %init_peer_id% ("op" "identity") [[]] $strStream-fix-2)
                        )
                       )
                      )
                      (xor
                       (call %init_peer_id% ("callbackSrv" "response") [$numOp-fix-0 $strArr-fix-1 $strStream-fix-2 $strEmptyStream [] [] []])
                       (call %init_peer_id% ("errorHandlingSrv" "error") [%last_error% 1])
                      )
                     )
                     (call %init_peer_id% ("errorHandlingSrv" "error") [%last_error% 2])
    ...
    let script = `
                    (xor
                     (seq
                      ...
                      (xor
                       (call %init_peer_id% ("callbackSrv" "response") [array-inline-0 $str-fix-1])
                       (call %init_peer_id% ("errorHandlingSrv" "error") [%last_error% 1])
                      )
                     )
                     (call %init_peer_id% ("errorHandlingSrv" "error") [%last_error% 2])
