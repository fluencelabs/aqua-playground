...
// Services
 ...
 export interface DTGetterDef {
     get_dt: (s: string, callParams: CallParams<'s'>) => Promise<{field:string}> | {field:string};
 }
...
// Functions
 ...
 export async function use_name1(name: string, config?: {ttl?: number}) : Promise<string>;
 export async function use_name1(peer: FluencePeer, name: string, config?: {ttl?: number}) : Promise<string>;
 export async function use_name1(...args) {
     let peer: FluencePeer;
     let name;
     let config;
     if (args[0] instanceof FluencePeer) {
...
config = args[1];
 ...
 (call %init_peer_id% ("errorHandlingSrv" "error") [%last_error% 2])
                ...
                h.on('getDataSrv', 'name', async () => {return name;});
 ...
 export async function use_name2(name: string, config?: {ttl?: number}) : Promise<string[]>;
 export async function use_name2(peer: FluencePeer, name: string, config?: {ttl?: number}) : Promise<string[]>;
 export async function use_name2(...args) {
     let peer: FluencePeer;
     let name;
     let config;
     if (args[0] instanceof FluencePeer) {
