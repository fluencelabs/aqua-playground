...
// Services
 ...
 export interface TestServiceDef {
     get_records: (key: string, callParams: CallParams<'key'>) => Promise<string[]> | string[];
 }
...
// Functions
 ...
 export async function append_records(peer: FluencePeer, peer_: string, srum: string[][], config?: {ttl?: number}) : Promise<void>;
...
config = args[2];
 ...
 (call %init_peer_id% ("errorHandlingSrv" "error") [%last_error% 1])
                ...
                h.on('getDataSrv', 'peer', async () => {return peer_;});
h.on('getDataSrv', 'srum', async () => {return srum;});
 ...
 export async function retrieve_records(peer: FluencePeer, peer_: string, config?: {ttl?: number}) : Promise<string[][]>;
