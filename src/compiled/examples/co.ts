...
export function registerCoService(service: { call: (callParams: CallParams<null>) => Promise<string> }): void;
export function registerCoService(
    serviceId: string,
    service: {
        call: (callParams: CallParams<null>) => Promise<string>;
    },
): void;
export function registerCoService(
    peer: FluencePeer,
