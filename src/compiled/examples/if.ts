...
export async function ifElseCall(client: FluenceClient, condition: boolean, ttlMsGeneratedArgument?: number): Promise<void> {
...
export async function ifElseNumCall(client: FluenceClient, condition: number, ttlMsGeneratedArgument?: number): Promise<void> {
    let request: RequestFlow;
    const promise = new Promise<void>((resolve, reject) => {
        request = new RequestFlowBuilder()
            .disableInjections()
