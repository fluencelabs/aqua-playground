...
// Functions
 ...
 export async function tryCatchTest(node_id: string, config?: {ttl?: number}) : Promise<string[]>;
 export async function tryCatchTest(peer: FluencePeer, node_id: string, config?: {ttl?: number}) : Promise<string[]>;
 export async function tryCatchTest(...args) {
     let peer: FluencePeer;
     let node_id;
     let config;
     if (args[0] instanceof FluencePeer) {
