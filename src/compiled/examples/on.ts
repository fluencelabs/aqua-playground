...
// Functions
 ...
 export async function getPeerExternalAddresses(peer: FluencePeer, otherNodePeerId: string, config?: {ttl?: number}) : Promise<string[]>;
...
config = args[1];
 ...
 (call %init_peer_id% ("errorHandlingSrv" "error") [%last_error% 3])
                ...
                h.on('getDataSrv', 'otherNodePeerId', async () => {return otherNodePeerId;});
 ...
 export async function getDistantAddresses(target: string, viaNode: string, config?: {ttl?: number}) : Promise<string[]>;
 export async function getDistantAddresses(peer: FluencePeer, target: string, viaNode: string, config?: {ttl?: number}) : Promise<string[]>;
...
config = args[2];
 ...
 (call %init_peer_id% ("errorHandlingSrv" "error") [%last_error% 3])
                ...
                h.on('getDataSrv', 'target', async () => {return target;});
h.on('getDataSrv', 'viaNode', async () => {return viaNode;});
                h.onEvent('callbackSrv', 'response', async (args) => {
    const [res] = args;
  resolve(res);
});
