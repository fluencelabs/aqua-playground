...
// Services
 ...
 export interface GetStrDef {
     retStr: (arg0: string, callParams: CallParams<'arg0'>) => Promise<string> | string;
 }
...
export function registerGetStr(peer: FluencePeer, serviceId: string, service: GetStrDef): void;
 ...
 export interface GetNumDef {
     retNum: (callParams: CallParams<null>) => Promise<number> | number;
 }
...
// Functions
 ...
 export async function multiReturnFunc(somethingToReturn: number[], smthOption: string | null, config?: {ttl?: number}) : Promise<[string[], number, string, number[], string | null, number]>;
 export async function multiReturnFunc(peer: FluencePeer, somethingToReturn: number[], smthOption: string | null, config?: {ttl?: number}) : Promise<[string[], number, string, number[], string | null, number]>;
...
config = args[2];
 ...
 (call %init_peer_id% ("errorHandlingSrv" "error") [%last_error% 2])
                ...
                h.on('getDataSrv', 'somethingToReturn', async () => {return somethingToReturn;});
h.on('getDataSrv', 'smthOption', async () => {return smthOption === null ? [] : [smthOption];});
                h.onEvent('callbackSrv', 'response', async (args) => {
   let opt: any = args;
