...
// Services
 ...
 export interface TestSDef {
     multiline: (a: string, b: string, c: boolean, callParams: CallParams<'a' | 'b' | 'c'>) => Promise<string> | string;
t: (arg0: string, callParams: CallParams<'arg0'>) => Promise<string> | string;
 }
...
export function registerTestS(peer: FluencePeer, serviceId: string, service: TestSDef): void;
 ...
 resp.result = await service.multiline(req.args[0], req.args[1], req.args[2], callParams)
 ...
 resp.retCode = ResultCodes.success;
 resp.result = await service.t(req.args[0], callParams)
...
// Functions
 ...
 export async function doStuff(a: string, b: string, c: boolean, d: boolean, e: string[], g: string[], str: string, config?: {ttl?: number}) : Promise<string[]>;
 export async function doStuff(peer: FluencePeer, a: string, b: string, c: boolean, d: boolean, e: string[], g: string[], str: string, config?: {ttl?: number}) : Promise<string[]>;
...
config = args[7];
 ...
 (call %init_peer_id% ("errorHandlingSrv" "error") [%last_error% 5])
                ...
                h.on('getDataSrv', 'a', async () => {return a;});
h.on('getDataSrv', 'b', async () => {return b;});
h.on('getDataSrv', 'c', async () => {return c;});
h.on('getDataSrv', 'd', async () => {return d;});
h.on('getDataSrv', 'e', async () => {return e;});
h.on('getDataSrv', 'g', async () => {return g;});
