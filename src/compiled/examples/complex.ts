...
export async function doStuff(client: FluenceClient, a: string, b: string, c: boolean, d: boolean, e: string[], g: string[], str: string, ttlMsGeneratedArgument?: number): Promise<string[]> {
