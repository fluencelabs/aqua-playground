...
// Services
 ...
 export interface CustomIdDef {
     id: (s: string, callParams: CallParams<'s'>) => Promise<string> | string;
 }
...
export function registerCustomId(peer: FluencePeer, serviceId: string, service: CustomIdDef): void;
 ...
 resp.result = await service.id(req.args[0], callParams)
...
// Functions
 ...
 export async function viaArr(node_id: string, viaAr: string[], config?: {ttl?: number}) : Promise<{external_addresses:string[]}>;
 export async function viaArr(peer: FluencePeer, node_id: string, viaAr: string[], config?: {ttl?: number}) : Promise<{external_addresses:string[]}>;
...
config = args[2];
 ...
 (call %init_peer_id% ("errorHandlingSrv" "error") [%last_error% 3])
                ...
                h.on('getDataSrv', 'node_id', async () => {return node_id;});
h.on('getDataSrv', 'viaAr', async () => {return viaAr;});
 ...
 export async function viaStream(node_id: string, viaStr: string[], config?: {ttl?: number}) : Promise<{external_addresses:string[]}>;
 export async function viaStream(peer: FluencePeer, node_id: string, viaStr: string[], config?: {ttl?: number}) : Promise<{external_addresses:string[]}>;
...
config = args[2];
 ...
 (call %init_peer_id% ("errorHandlingSrv" "error") [%last_error% 3])
                ...
                h.on('getDataSrv', 'node_id', async () => {return node_id;});
h.on('getDataSrv', 'viaStr', async () => {return viaStr;});
                h.onEvent('callbackSrv', 'response', async (args) => {
    const [res] = args;
  resolve(res);
});
 ...
 export async function viaOpt(relay: string, node_id: string, viaOpt: string | null, config?: {ttl?: number}) : Promise<{external_addresses:string[]}>;
 export async function viaOpt(peer: FluencePeer, relay: string, node_id: string, viaOpt: string | null, config?: {ttl?: number}) : Promise<{external_addresses:string[]}>;
...
h.on('getDataSrv', 'node_id', async () => {return node_id;});
h.on('getDataSrv', 'viaOpt', async () => {return viaOpt === null ? [] : [viaOpt];});
                h.onEvent('callbackSrv', 'response', async (args) => {
    const [res] = args;
  resolve(res);
});
