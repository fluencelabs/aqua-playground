...
// Services
 ...
 export interface NoopDef {
     array: (a: string, b: string | null, c: string | null, d: string | null, callParams: CallParams<'a' | 'b' | 'c' | 'd'>) => Promise<string[]> | string[];
array_length: (array: string[], callParams: CallParams<'array'>) => Promise<number> | number;
bytes_from_b58: (b: string, callParams: CallParams<'b'>) => Promise<number[]> | number[];
bytes_to_b58: (bs: number[], callParams: CallParams<'bs'>) => Promise<string> | string;
concat: (a: string[], b: string[] | null, c: string[] | null, d: string[] | null, callParams: CallParams<'a' | 'b' | 'c' | 'd'>) => Promise<string[]> | string[];
concat_strings: (a: string, b: string, callParams: CallParams<'a' | 'b'>) => Promise<string> | string;
identity: (s: string | null, callParams: CallParams<'s'>) => Promise<string | null> | string | null;
noop: (callParams: CallParams<null>) => Promise<void> | void;
sha256_string: (s: string, callParams: CallParams<'s'>) => Promise<string> | string;
string_from_b58: (b: string, callParams: CallParams<'b'>) => Promise<string> | string;
string_to_b58: (s: string, callParams: CallParams<'s'>) => Promise<string> | string;
 }
...
export function registerNoop(peer: FluencePeer, serviceId: string, service: NoopDef): void;
 ...
 resp.retCode = ResultCodes.success;
 await service.noop(callParams); resp.result = {}
 ...
 export interface MyExportSrvDef {
     another_str: (callParams: CallParams<null>) => Promise<string> | string;
 }
...
// Functions
 ...
 export async function some_str(config?: {ttl?: number}) : Promise<string>;
 export async function some_str(peer: FluencePeer, config?: {ttl?: number}) : Promise<string>;
 export async function some_str(...args) {
     let peer: FluencePeer;
 ...
 export async function some_random_func(config?: {ttl?: number}) : Promise<string>;
 export async function some_random_func(peer: FluencePeer, config?: {ttl?: number}) : Promise<string>;
 export async function some_random_func(...args) {
     let peer: FluencePeer;
