...
export function registerHelloWorld(peer: FluencePeer, serviceId: string, service: HelloWorldDef): void;
 ...
 resp.retCode = ResultCodes.success;
 await service.sayHello(req.args[0], callParams); resp.result = {}
...
// Functions
 ...
 export async function callMeBack(callback: (arg0: string, arg1: number, callParams: CallParams<'arg0' | 'arg1'>) => Promise<void> | void, config?: {ttl?: number}) : Promise<void>;
 export async function callMeBack(peer: FluencePeer, callback: (arg0: string, arg1: number, callParams: CallParams<'arg0' | 'arg1'>) => Promise<void> | void, config?: {ttl?: number}) : Promise<void>;
