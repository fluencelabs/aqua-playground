    ...
    let script = `
                    (xor
                     (seq
                        ...
                        (seq
                         ...
                         (new $p2Id-0
                          (seq
                           ...
                           (call %init_peer_id% ("op" "identity") [$p2Id-0.$.[0]!] p2Id-fix-0)
                          )
                         )
                        )
                        (call -relay- ("op" "noop") [])
                        ...
                        (seq
                         (new $p2Id
                          (seq
                           ...
                           (call peer2 ("op" "identity") [$p2Id.$.[0]!] p2Id-fix-0-0)
                          )
                         )
                         (call -relay- ("op" "noop") [])
                        )
                      ...
                      (xor
                       (call %init_peer_id% ("callbackSrv" "response") [p2Id-fix-0 p2Id-fix-0-0])
