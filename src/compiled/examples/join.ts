                      ...
                      (seq
                       ...
                       (new $nodes2
                        (seq
                         ...
                         (call %init_peer_id% ("op" "identity") [$nodes2] $nodes2-fix-0)
                        )
                       )
                      )
                      (xor
                       (call %init_peer_id% ("callbackSrv" "response") [$nodes2-fix-0])
                       ...
                       (new $nodes2
                        (new $infos
                         (seq
                          ...
                          (call %init_peer_id% ("op" "identity") [$infos] $infos-fix-0)
                         )
                        )
                       )
                      )
                      (xor
                       (call %init_peer_id% ("callbackSrv" "response") [$infos-fix-0])
                       (call %init_peer_id% ("errorHandlingSrv" "error") [%last_error% 2])
                      )
                     )
                     (call %init_peer_id% ("errorHandlingSrv" "error") [%last_error% 3])
