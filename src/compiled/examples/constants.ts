...
export function registerOpO(service: {
    identity: (arg0: string, callParams: CallParams<'arg0'>) => Promise<string>;
}): void;
export function registerOpO(
    serviceId: string,
    service: {
        identity: (arg0: string, callParams: CallParams<'arg0'>) => Promise<string>;
    },
...
export function registerGetter(service: {
    createStr: (arg0: number, callParams: CallParams<'arg0'>) => Promise<string>;
}): void;
...
export function registerGetter(...args) {
    ...
    peer.callServiceHandler.use(async (req, resp, next) => {
        ...
        if (req.fnName === 'createStr') {
            ...
            resp.retCode = ResultCodes.success;
            resp.result = await service.createStr(req.args[0], callParams);
        }
...
export async function callConstant(config?: { ttl?: number }): Promise<string[]>;
export async function callConstant(peer: FluencePeer, config?: { ttl?: number }): Promise<string[]>;
export async function callConstant(...args) {
    let peer: FluencePeer;
