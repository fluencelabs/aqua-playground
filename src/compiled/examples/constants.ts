...
export function registerOpO(service: { identity: (arg0: string, callParams: CallParams<'arg0'>) => string }): void;
...
export function registerGetter(service: { createStr: (arg0: number, callParams: CallParams<'arg0'>) => string }): void;
