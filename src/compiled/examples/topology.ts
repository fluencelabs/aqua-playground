                      ...
                      (seq
                       ...
                       (new $results
                        (seq
                         ...
                         (call %init_peer_id% ("op" "identity") [$results] $results-fix-0)
                        )
                       )
                      )
                      (xor
                       (call %init_peer_id% ("callbackSrv" "response") [$results-fix-0])
                      ...
                      (seq
                       ...
                       (new $nodes
                        (seq
                         ...
                         (call %init_peer_id% ("op" "identity") [$nodes] $nodes-fix-0)
                        )
                       )
                      )
                      (xor
                       (call %init_peer_id% ("callbackSrv" "response") [$nodes-fix-0])
