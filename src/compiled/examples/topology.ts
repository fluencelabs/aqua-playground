...
// Services
 ...
 export interface TestoDef {
     getString: (arg0: string, callParams: CallParams<'arg0'>) => Promise<string> | string;
 }
...
// Functions
 ...
 export async function topologyTest(me: string, myRelay: string, friend: string, friendRelay: string, config?: {ttl?: number}) : Promise<string>;
 export async function topologyTest(peer: FluencePeer, me: string, myRelay: string, friend: string, friendRelay: string, config?: {ttl?: number}) : Promise<string>;
 export async function topologyTest(...args) {
     let peer: FluencePeer;
     let me;
let myRelay;
let friend;
...
config = args[4];
 ...
 (call %init_peer_id% ("errorHandlingSrv" "error") [%last_error% 3])
                ...
                h.on('getDataSrv', 'me', async () => {return me;});
h.on('getDataSrv', 'myRelay', async () => {return myRelay;});
h.on('getDataSrv', 'friend', async () => {return friend;});
h.on('getDataSrv', 'friendRelay', async () => {return friendRelay;});
