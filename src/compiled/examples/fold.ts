...
config = args[1];
 ...
 (call %init_peer_id% ("errorHandlingSrv" "error") [%last_error% 1])
                ...
                h.on('getDataSrv', 'strings', async () => {return strings;});
 ...
 export async function iterateAndPrintParallel(nodes: string[], c: (arg0: {external_addresses:string[]}, callParams: CallParams<'arg0'>) => Promise<void> | void, config?: {ttl?: number}) : Promise<void>;
 export async function iterateAndPrintParallel(peer: FluencePeer, nodes: string[], c: (arg0: {external_addresses:string[]}, callParams: CallParams<'arg0'>) => Promise<void> | void, config?: {ttl?: number}) : Promise<void>;
...
config = args[2];
 ...
 (call %init_peer_id% ("errorHandlingSrv" "error") [%last_error% 3])
                ...
                h.on('getDataSrv', 'nodes', async () => {return nodes;});
