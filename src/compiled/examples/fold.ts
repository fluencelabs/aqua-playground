...
export async function iterateAndPrint(client: FluenceClient, strings: string[], ttlMsGeneratedArgument?: number): Promise<void> {
...
export async function iterateAndPrintParallel(client: FluenceClient, nodes: string[], c: (arg0: {external_addresses:string[]}) => void, ttlMsGeneratedArgument?: number): Promise<void> {
    let request: RequestFlow;
    const promise = new Promise<void>((resolve, reject) => {
        request = new RequestFlowBuilder()
            .disableInjections()
