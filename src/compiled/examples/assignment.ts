...
// Services
 ...
 export interface OpHaDef {
     array: (a: string, b: string, callParams: CallParams<'a' | 'b'>) => Promise<string[]> | string[];
identity: (a: string, callParams: CallParams<'a'>) => Promise<string> | string;
 }
...
config = args[1];
 ...
 (call %init_peer_id% ("errorHandlingSrv" "error") [%last_error% 2])
                ...
                h.on('getDataSrv', 'arg', async () => {return arg;});
